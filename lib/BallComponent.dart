...
class BallComponent extends PositionComponent {
  ...
  BallComponent({
    this.ballRadius = 18.0,
    this.ballColor = const Color(0xFFF80404),
  ...
  void _initializePaints() {
    ...
    shadowPaint = Paint()
      ..color = ballColor.withValues(alpha: 0)
      ..style = PaintingStyle.fill;
  ...
  void addBounceEffect() {
    ...
    // Reset to happy after a short time
    Future.delayed(const Duration(milliseconds: 300), () {
      setExpression(BallExpression.happy);
    });
  }
